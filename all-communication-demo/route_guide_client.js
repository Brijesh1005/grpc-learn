...
var client = new routeguide.RouteGuide('localhost:50011',
...
function runGetFeature(callback) {
  ...
  console.log(FgGreen, "####### Unary to Unary communication #########");
  console.log(FgWhite);
...
function runListFeatures(callback) {
  ...
  console.log(FgGreen, "####### Unary to Stream communication #########");
  console.log(FgWhite);
  console.log(FgMagenta, "####### Client Unary request #########");
  console.log(FgWhite, 'Looking for features between 40, -75 and 42, -73');
  var call = client.listFeatures(rectangle);
  console.log(FgMagenta, "####### Server Stream response #########");
  console.log(FgWhite);
...
function runRecordRoute(callback) {
  ...
  console.log(FgGreen, "####### Stream to Unary communication #########");
  console.log(FgWhite);
  fs.readFile(path.resolve(argv.db_path), function(err, data) {
    ...
    var call = client.recordRoute(function(error, stats) {
      ...
      console.log(FgMagenta, "####### Server Unary response #########");
      console.log(FgWhite);
    ...
    var point_senders = [];
    console.log(FgMagenta, "####### Client Stream request #########");
    console.log(FgWhite);
...
function runRouteChat(callback) {
  ...
  console.log(FgGreen, "####### Stream to Stream communication #########");
  console.log(FgWhite);
